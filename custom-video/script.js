...
console.log(
    'Приветствую, проверяющий!\nМожно заметить, что работа выполнена не по шаблону.\nПоэтому меня интересует объективная критика и замечания.\nВозможно найдутся баги или странное поведение элементов.\nСписок реализованного функционала:\n- выбор видео из нескольких вариантов\n- кнопки старт, стоп, громкость, полноэкранный режим\n- пауза по клику по видео\n- выезжающая панель управления\n- управление кнопками с клавиатуры\nТеперь по поводу кнопок клавиатуры:\nстрелки вправо и влево - подмотка видео на 20 секунд (при медленном интернете отображается после загрузки видео)\nстрелки вверх и вниз - регулировка громкости\nF - полноэкранный режим и выход из него\nпробел - пауза или старт видео\nS - стоп воспроизведения, сброс на начало видео\nM - выключить или включить обратно звук\nEsc - выход из полноэкранного режима\nТакже рализовано отображение времени видео, прошедшего с начала, и полное время видеоролика.\nПри завершении видео прячется панель управления и возвращается заставка текущего видео\nИндикатор громкости меняется в зависимости от текущего уровня громкости\nИ последнее - дизайн полностью респонсивный, все элементы сохраняют относительные пропорции\nОчень сильно интересует наличие багов и неадекватного поведения элементов страницы.\nВАЖНО! при проверке должна быть ЗАКРЫТА панель F12. Иначе отображение изменений происходит с задержкой\nСпасибо за внимание к моей работе!'
)
